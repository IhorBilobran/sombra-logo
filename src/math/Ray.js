...
var Ray = /** @class */ (function () {
    ...
    Ray.prototype.intersectSphere = function (sphere, optionalTarget) {
        if (optionalTarget === void 0) { optionalTarget = new Vector3_1.Vector3(); }
    ...
    Ray.recast_v1 = new Vector3_1.Vector3();
    Ray.distanceSqToPoint_v1 = new Vector3_1.Vector3();
    Ray.distanceSqToSegment_segCenter = new Vector3_1.Vector3();
    Ray.distanceSqToSegment_segDir = new Vector3_1.Vector3();
    Ray.distanceSqToSegment_diff = new Vector3_1.Vector3();
    Ray.intersectSphere_v1 = new Vector3_1.Vector3();
    Ray.intersectsBox_v = new Vector3_1.Vector3();
    Ray.intersectTriangle_diff = new Vector3_1.Vector3();
    Ray.intersectTriangle_edge1 = new Vector3_1.Vector3();
    Ray.intersectTriangle_edge2 = new Vector3_1.Vector3();
    Ray.intersectTriangle_normal = new Vector3_1.Vector3();
    return Ray;
}());
exports.Ray = Ray;
